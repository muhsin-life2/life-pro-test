...
const Navbar = ({ data, brands_data, sessionServ }) => {
  ...
  //     }
  //     else {
  //       const result: SignInResponse = await signIn('credentials', { email: phoneNumberforOTP, code: otpValue, isPhone: "false", redirect: false })
    ...
    <>
      ...
      <div className=" sticky top-0  z-50 bg-white mx-auto  opacity-95 ">
        ...
        <div className="bg-indigo-100 ">
          <div className="mx-auto flex max-w-[1440px] gap-5 bg-indigo-100 px-4 py-4 ">
            <Link href={`/home`} className="my-auto">
              <Image src="https://www.lifepharmacy.com/images/logo.svg" alt=""
                className=" my-auto filter md:flex hidden" width={380} height={250} />
            ...
            <div className="grid grid-flow-col w-100 gap-5 md:flex lg:flex my-auto">
              <Menu as="div" className="relative inline-block text-left">
                <Menu.Button className=" flex flex-col md:flex lg:flex" onClick={() => { setauthModal(true) }}>
                  ...
                  <div className="text-[11px] text-center ">Arabic</div>
                </Menu.Button>
              ...
              <a href="#" className="flex flex-col md:hidden lg:flex hidden relative">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                  stroke="currentColor" className="mx-auto my-auto h-10 w-10 text-white bg-orange-200 p-2 rounded-full stroke-orange-500">
                  <path strokeLinecap="round" strokeLinejoin="round"
                    d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                </svg>
                <div className="text-[11px] text-center text-orange-500">Cart</div>
              ...
              <a href="#" className="flex flex-col md:hidden lg:flex hidden">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="mx-auto my-auto  h-10 w-10 text-red-500 p-2 bg-red-200 rounded-full"><path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"></path></svg>
                <div className="text-center text-[11px]  text-red-500">WishList</div>
              </a>
            </div>
          </div>
